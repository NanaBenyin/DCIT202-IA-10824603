        ...
        <View style={{ marginTop: 30 }}>
          <View
            ...
            <Image
              ...
              source={require('./Images/dwa-1.png')}
            />
            <Text style={{ color: '#828080', textAlign: 'center' }}>
              DD Classic Watch
            </Text>
        ...
        <View style={{ marginTop: 30 }}>
          <View
            ...
            <Image
              ...
              source={require('./Images/dwa-5.png')}
            />
            <Text style={{ color: '#828080', textAlign: 'center' }}>
              Schaffhausen{' '}
            </Text>
        ...
        <View style={{ marginTop: 30 }}>
          <View
            ...
            <Image
              ...
              source={require('./Images/dwa-3.png')}
            />
            <Text style={{ color: '#828080', textAlign: 'center' }}>
              DD Classic Watch
            </Text>
        ...
        <View style={{ marginTop: 30 }}>
          <View
            ...
            <Image
              ...
              source={require('./Images/dwa-4.png')}
            />
            <Text style={{ color: '#828080', textAlign: 'center' }}>
              Schaffhausen{' '}
            </Text>
